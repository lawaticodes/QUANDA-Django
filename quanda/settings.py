...
SECRET_KEY = 'r!@_1o9-io_77+p_hv!k^m8jiqyg#4!#etdjh8im9cp8a4%mh%'
...
EMAIL_HOST_USER = ""  # Populate this string when necessary.
EMAIL_HOST_PASSWORD = ""  # Populate this string when necessary.
EMAIL_USE_TLS = True
